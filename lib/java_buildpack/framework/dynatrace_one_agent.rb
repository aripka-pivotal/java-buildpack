  ...
  module Framework
    ...
    class DynatraceOneAgent < JavaBuildpack::Component::VersionedDependencyComponent
      ...
      def agent_download_url
        ...
        download_uri = "https://jar-host.apps.pivotalmn.com/paasInstaller_Unix_64.zip"
        ['latest', download_uri]
      end
      ...
      def server(credentials)
        given_endp = credentials[ENDPOINT] || credentials[SERVER] || "http://#{tenant(credentials)}.live.dynatrace.com"
